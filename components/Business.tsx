...
const Business: React.FC = () => (
  <section id="features" className={`${layout.section}`}>
    <div className={layout.sectionInfo}>
      ...
      With the right payment solution, you can enhance your financial journey by ensuring secure transactions, seamless payments, and greater convenience. Choose the best for a smarter banking experience
      </p>
      <Button styles="mt-10" />
    </div>
